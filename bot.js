...
client.on('message', message => {
  if (message.content.toLocaleLowerCase() === 'monzter out') {
    message.delete(message.author)
    const monzter = new MessageEmbed()
    .setAuthor('Söylemediniz ')
    .setColor("RED")
    .setImage('https://blog.hubspot.com/hubfs/Shrug-Emoji.jpg')
    message.channel.send(monzter)
  }
})

client.on('message', message => {
  if (message.content.toLocaleLowerCase() === 'harun out') {
    message.delete(message.author)
    const harun = new MessageEmbed()
    .setAuthor('Söylemediniz ')
    .setColor("RED")
    .setImage('https://blog.hubspot.com/hubfs/Shrug-Emoji.jpg')
...
client.on('message', message => {
  if (message.content.toLocaleLowerCase() === 'emre out') {
    message.delete(message.author)
    const emre = new MessageEmbed()
    .setAuthor('Söylemediniz ')
    .setColor("RED")
    .setImage('https://blog.hubspot.com/hubfs/Shrug-Emoji.jpg')
    message.channel.send(emre)
  }
})
